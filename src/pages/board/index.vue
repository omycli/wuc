<template>
  <div class="md-board">
    <view class="md-board__slide">
      <swiper class="md-board__swiper" @change="onSwiperChange" :current="curIndex" :circular="true"  :indicator-dots="true" :autoplay="true" :interval="3000" :duration="300">
...
export default {
  ...
  computed: {
    ...
    styles () {
      let i;
      let scaledata = this.curIndex === i ? 0.9 : 0.65
      let translatedata = this.curIndex === (i - 1 || this.curIndex === i + 1) ? this.curIndex - i * 30 : 0
      return `-webkit-transform: scale(${scaledata} translate(${translatedata})%, 0)`
    }
  },
